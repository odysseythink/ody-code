...
export default withMermaid(defineConfig({
  base,
  title: 'Ody Code CLI Docs',
  description: 'Ody Code CLI Documentation',
  ...
  locales: {
    zh: {
      ...
      lang: 'zh-CN',
      link: '/zh/',
      title: 'Ody Code CLI 文档',
      description: 'Ody Code CLI 用户文档',
      themeConfig: {
        nav: [
          ...
          '/zh/guides/': [
            {
              ...
              items: [
                ...
                { text: '从 ody 迁移', link: '/zh/guides/migration' },
    ...
    en: {
      ...
      link: '/en/',
      title: 'Ody Code CLI Docs',
      description: 'Ody Code CLI User Documentation',
      themeConfig: {
        nav: [
          ...
          '/en/guides/': [
            {
              ...
              items: [
                ...
                { text: 'Migrating from ody', link: '/en/guides/migration' },
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/odysseythink/ody-code' },
    ],
  },
