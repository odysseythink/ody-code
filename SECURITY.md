...
Currently, Ody Code only provides security support for the latest released version.
...
- GitHub Security Advisories — https://github.com/odysseythink/ody-code/security/advisories/new
...
- Affected version (output of `ody --version`)
- Reproduction steps
- Impact assessment
