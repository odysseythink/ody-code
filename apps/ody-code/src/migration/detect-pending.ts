...
import { detectMigration, type MigrationPlan } from '@odysseythink/migration-legacy';
...
export interface DetectPendingInput {
   ...
   * `.skip-migration-from-kimi-cli`). The explicit `ody migrate` command sets
 ...
 * into *this* target home. A marker written for a different `ODY_CODE_HOME`
