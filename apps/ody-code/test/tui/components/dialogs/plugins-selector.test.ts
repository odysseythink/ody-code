...
describe('plugins selector dialogs', () => {
  it('trusts only built-in Kimi CDN plugin paths', () => {
    expect(pluginTrustLabel({
      ...
      hasErrors: false,
      source: 'zip-url',
      originalSource: 'https://code.ody.com/ody-code/plugins/official/kimi-datasource.zip',
    })).toBe('official');
    expect(pluginTrustLabel({
      id: 'superpowers',
      ...
      hasErrors: false,
      source: 'zip-url',
      originalSource: 'https://code.ody.com/ody-code/plugins/curated/superpowers.zip',
    })).toBe('curated');
    expect(pluginTrustLabel({
      id: 'demo',
      displayName: 'Demo',
    ...
    expect(pluginTrustLabel({
      ...
      hasErrors: false,
      source: 'local-path',
      originalSource: 'https://code.ody.com/ody-code/plugins/official/local',
    })).toBe('third-party');
  });
