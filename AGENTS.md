...
- `apps/ody-code`: the CLI / TUI application. It consumes core capabilities through `@odysseythink/ody-code-sdk` and must not depend directly on `@odysseythink/agent-core`.
