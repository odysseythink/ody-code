...
describe('FileSystemProductStateStore', () => {
  it('appendProfile and readProfile round-trip', async () => {
    const kaos = mockKaos();
    const store = new FileSystemProductStateStore(kaos as any, '/fake/home/.ody-code');
    const entry: BuilderProfileEntry = {
      ...
      designDoc: '/proj/.ody-code/product/2026-06-16-test.md',
...
describe('NoopProductStateStore', () => {
  it('does not throw on any method', async () => {
    const store = new NoopProductStateStore();
