...
import { AppendBuilderProfileInputSchema } from '../../../../src/tools/builtin/office-hours/append-profile';

/**
 * The `signals` description is read by the model when it decides which founder
 * signals to record. It must stay in lockstep with the office-hours prompt
