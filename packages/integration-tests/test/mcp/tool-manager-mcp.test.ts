import type { ContentPart, Tool } from '@odysseythink/kosong';
import { describe, expect, it } from 'vitest';

import type { Agent } from '@odysseythink/agent-core';
import { ToolManager } from '@odysseythink/agent-core';
import type { MCPClient } from '@odysseythink/mcp-host';
import { testAgent } from '@odysseythink/agent-core/test/helpers';
import { executeTool } from '@odysseythink/agent-core/test/helpers';
