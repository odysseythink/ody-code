...
type ClientFactory = NonNullable<
  ConstructorParameters<typeof KimiChatProvider>[0]['clientFactory']
>;
...
export async function runTsKosongKimiGolden(fixture: Fixture): Promise<GoldenResult> {
  const provider = new KimiChatProvider({
    ...
    generationKwargs: {
      reasoning_effort: fixture.providerOptions.reasoningEffort,
      extra_body: fixture.providerOptions.extraBody,
    },
