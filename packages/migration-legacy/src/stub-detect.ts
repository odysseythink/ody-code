...
export const DEFAULT_CONFIG_FILE_TEXT =
  '# ~/.ody-code/config.toml\n' +
  '# Runtime settings for Ody Code.\n' +
  '# This file starts empty so built-in defaults can apply.\n' +
  '# Login will populate managed Kimi provider and model entries.\n';

// Verbatim from apps/ody-code/src/tui/config.ts:renderTuiConfig(DEFAULT_TUI_CONFIG)
export const DEFAULT_TUI_RENDER =
  '# ~/.ody-code/tui.toml\n' +
  '# Terminal UI preferences for ody-code.\n' +
  '# Agent/runtime settings stay in ~/.ody-code/config.toml.\n' +
  '\n' +
