 ...
 * `~/.ody-code/migration-report.json` and surfaced in the terminal summary.
 */
...
export interface MigrationSummary {
  ...
  readonly mcp: {
    ...
    /** Source servers dropped because ody-code's MCP schema rejects them. */
...
export interface MigrationNotices {
   ...
   * ody-code instead. Empty when the legacy install had no OAuth login.
   */
