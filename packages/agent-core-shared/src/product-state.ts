...
export interface ProductStateStore {
  ...
  appendAnalytics(event: ProductAnalyticsEvent): Promise<void>;
...
export class FileSystemProductStateStore implements ProductStateStore {
  ...
  constructor(
    ...
    this.baseDir = join(homeDir, 'product');
  }
  ...
  async appendAnalytics(event: ProductAnalyticsEvent): Promise<void> {
    await this.ensureDir();
...
export class NoopProductStateStore implements ProductStateStore {
  async appendProfile(_entry: BuilderProfileEntry): Promise<void> {}
  async readProfile(): Promise<readonly BuilderProfileEntry[]> {
    return [];
  }
  async appendAnalytics(_event: ProductAnalyticsEvent): Promise<void> {}
